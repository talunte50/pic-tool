export default {
    title: '在线打开 Word、Excel 和 PPT - 免费安全 Office 查看器 | pic-tool',
    ...
    cards: [
        ...
        { title: '查看 PDF 文件', desc: '使用 pic-tool 现有 PDF 渲染能力在本地打开 PDF 页面。', icon: 'File' },
    ...
    seoIntro: 'pic-tool Viewer 针对在线打开 docx、office 查看器、pptx open、zip 在线解压和 rar extractor online 等常见搜索需求设计，帮助你无需安装 Word、Excel、PowerPoint、Acrobat 或解压软件即可快速查看文件。',
    featureSections: [
        {
            title: '在线打开 DOCX',
