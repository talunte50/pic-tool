export default {
    ...
    seoIntro: 'pic-tool Video Convert é um gif maker local-first, conversor de vídeo para GIF e ferramenta MP4 para GIF com ffmpeg.wasm.',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Sim. O arquivo é processado localmente com ffmpeg.wasm; o pic-tool não envia seu vídeo para servidor.'
        },
        {
