...
export default {
    ...
    seoIntro: 'pic-tool Video Convert は ffmpeg.wasm を使ったローカル優先の gif maker、video to GIF 変換、MP4 to GIF ツールです。ffmpeg-webCLI に近いワークフローをブラウザ内で提供します。',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'はい。ファイルは ffmpeg.wasm によりブラウザ内でローカル処理されます。pic-tool は動画を変換サーバーへアップロードしません。'
        },
        {
