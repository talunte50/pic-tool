...
export default {
    ...
    seoIntro: 'pic-tool Video Convert là công cụ gif maker, video to GIF và MP4 to GIF ưu tiên xử lý cục bộ, chạy bằng ffmpeg.wasm. Công cụ hỗ trợ các quy trình giống ffmpeg-webCLI và giữ tệp trong trình duyệt.',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Có. Tệp được xử lý cục bộ trong trình duyệt bằng ffmpeg.wasm. pic-tool không tải video của bạn lên máy chủ chuyển đổi.'
        },
        {
