export default {
    ...
    description:
        "Compresseur d'images en ligne gratuit pour des sites web plus rapides ! Réduisez la taille des fichiers de vos images WEBP, JPEG et PNG avec une implémentation de compression basée sur Webassembly.",
    ...
    vsTitle: 'pic-tool Compress vs TinyPNG Compress',
    vsTitle1: 'pic-tool Compress',
