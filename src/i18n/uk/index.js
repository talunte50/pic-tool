...
export default {
    askAiTitle: 'Запитати {ai} про pic-tool',
    title: 'pic-tool - онлайн-інструменти для скриншотів і зображень',
    ...
    terms: 'Умови',
    blog: 'Блог',
    footerToolsTitle: 'Основні інструменти pic-tool',
    ...
    localProcessing: {
        ...
        cont1: 'Файли обробляються локально у вашому браузері. pic-tool не потребує завантаження зображень або відео на сервер для цих інструментів.',
