...
export default {
    ...
    tip: 'Convert MP4 to GIF, make GIFs from video, compress clips, and edit media locally with ffmpeg.wasm. No upload.',
    seoIntro: 'pic-tool Video Convert is a local-first GIF maker, video to GIF converter, and MP4 to GIF tool powered by ffmpeg.wasm.',
    tool: {
        ...en.tool,
