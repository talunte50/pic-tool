export default {
    title: 'Open Word, Excel & PPT Online - Free Office Viewer | pic-tool',
    description: 'Open DOCX, XLSX, PPTX, CSV, PDF, ZIP, and RAR files online in a local-first browser viewer. No install and no required upload.',
    keywords: 'open docx online, office viewer, open pptx online, excel viewer online, open xlsx online, pdf viewer online, zip extractor online, rar extractor online',
    h1: 'Open Word, Excel & PPT Online - Free Secure Office Viewer',
    tip: 'No installation required. Your files stay in the browser for quick preview.',
    cards: [
        ...
        { title: 'View PDF Files', desc: 'Render PDF pages locally with the PDF library already used by pic-tool.', icon: 'File' },
    ...
    localCont1: 'Open DOCX, XLSX, and PPTX directly in your browser.',
    localCont2: 'Files are processed locally whenever possible, so private documents do not need a remote viewer.',
    supportTitle: 'Supported document and archive formats',
    supportCont1: 'Previews include DOCX, XLSX, PPTX, CSV, PDF, images, text files, ZIP, and RAR.',
    supportCont2: 'ZIP and RAR can be opened as archive trees for preview or extraction.',
    seoTitle: 'Free online office viewer for DOCX, XLSX, PPTX, PDF, CSV, ZIP and RAR',
    seoIntro: 'pic-tool Viewer is built for searches like open docx online, office viewer, open pptx online, zip extractor online, and rar extractor online.',
    featureSections: [
        ...
        { title: 'PDF and CSV viewer', body: 'PDF pages render with pdf.js, while CSV files open in a clean table preview.' },
        { title: 'ZIP and RAR extractor online', body: 'Browse archive contents in folder or tree mode, preview files, and download extracted items.' }
    ],
    faqTitle: 'Office Viewer FAQ',
    faqs: [
        { question: 'Can I open DOCX online without uploading it?', answer: 'Yes. DOCX files are rendered in your browser with a local WebAssembly and Canvas viewer.' },
        { question: 'Can I use this as a RAR extractor online?', answer: 'Yes. RAR archives can be listed and supported files can be extracted for preview or download in the browser.' },
        { question: 'Does the viewer support old DOC, XLS, or PPT files?', answer: 'The office renderer supports modern Office Open XML files: DOCX, XLSX, and PPTX. Older binary Office formats are not supported.' }
    ],
