...
export default {
    ...
    keywords: 'pic-tool, easy to screenshot, edit photo, photo converter, image converter, editor online, convert image format online, convert image to jpg, jpg to webp, jpg to png',
    privacy: 'Privacy',
    terms: 'Terms',
    blog: 'Blog',
    footerToolsTitle: 'Core pic-tool Tools',
    footerToolsIntro: 'Quick links to screenshot, image, video, and local browser tools.',
    localProcessing: {
        title: 'No Upload, Local Processing',
