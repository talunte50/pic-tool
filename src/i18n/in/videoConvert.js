...
export default {
    ...
    seoIntro: 'pic-tool Video Convert is a local-first GIF maker, video to GIF converter, and MP4 to GIF tool powered by ffmpeg.wasm. It supports common creator and product-video workflows while keeping files inside your browser.',
    tool: {
        ...en.tool,
