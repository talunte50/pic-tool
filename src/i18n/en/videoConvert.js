export default {
    ...
    seoIntro: 'pic-tool Video Convert is a local-first gif maker, video to gif converter, and MP4 to GIF tool powered by ffmpeg.wasm. It covers common video editing jobs from ffmpeg-webCLI-style workflows while keeping files inside your browser.',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Yes. The file is processed locally in your browser with ffmpeg.wasm. pic-tool does not upload your video to a conversion server.'
        },
        {
