export default {
    title: 'Word, Excel, PPT 온라인 열기 - 무료 Office Viewer | pic-tool',
    ...
    seoIntro: 'pic-tool Viewer는 open docx online, office viewer, pptx open, zip extractor, rar extractor 검색을 위해 설계되었습니다.',
    featureSections: [
        {
            title: 'DOCX 온라인 열기',
