export default {
    ...
    captureTechCont1: 'pic-tool usa navigator.mediaDevices.getDisplayMedia para solicitar el permiso de captura directamente en el navegador, sin plugins ni software adicional.',
