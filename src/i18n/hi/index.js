...
export default {
    ...
    terms: 'Terms',
    blog: 'Blog',
    footerToolsTitle: 'मुख्य pic-tool टूल्स',
    footerToolsIntro: 'Screenshot, image, video और browser-local tools के लिए quick links.',
    localProcessing: {
        title: 'Upload नहीं, local processing',
        cont1: 'आपकी files आपके browser में locally process होती हैं. इन tools के लिए pic-tool images या videos को server पर upload नहीं करता.',
