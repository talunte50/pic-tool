...
export default {
    askAiTitle: 'Спросить {ai} о pic-tool',
    title: 'Скриншот онлайн и фоторедактор в браузере | pic-tool',
    description:
    ...
    keywords:
        'pic-tool, скриншот, редактор фото, конвертер фото, конвертер изображений, онлайн-редактор, изменение формата изображения онлайн, конвертация изображения в jpg, jpg в webp, jpg в png',
    privacy: 'Конфиденциальность',
    terms: 'Условия',
    blog: 'Блог',
    footerToolsTitle: 'Основные инструменты pic-tool',
    ...
    localProcessing: {
        ...
        cont1: 'Файлы обрабатываются локально в вашем браузере. pic-tool не требует загрузки изображений или видео на сервер для этих инструментов.',
