...
export default {
    ...en,
    poweredByPre: 'Conversion vidéo propulsée par ',
    poweredByMid: ". Modèle d'interaction adapté de ",
    poweredByPost: '.',
    title: 'Créateur de GIF, Video to GIF et MP4 to GIF | pic-tool',
    ...
    seoIntro: 'pic-tool Video Convert est un créateur de GIF local, un convertisseur video to GIF et un outil MP4 to GIF propulsé par ffmpeg.wasm. Il reprend les flux pratiques de ffmpeg-webCLI tout en gardant les fichiers dans le navigateur.',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Oui. Le fichier est traité localement dans votre navigateur avec ffmpeg.wasm. pic-tool n’envoie pas votre vidéo vers un serveur de conversion.'
        },
        {
