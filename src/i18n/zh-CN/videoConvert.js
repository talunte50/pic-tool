export default {
    ...
    seoIntro: 'pic-tool Video Convert 是基于 ffmpeg.wasm 的本地优先 gif maker、video to gif 和 MP4 to GIF 工具。它参考 ffmpeg-webCLI 的工作流，覆盖常见视频处理场景，同时让文件保留在当前浏览器中。',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: '不会。pic-tool 使用 ffmpeg.wasm 在浏览器本地处理文件，视频不会上传到转换服务器。'
        },
        {
