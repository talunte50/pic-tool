...
export default {
    ...
    terms: 'Bedingungen',
    blog: 'Blog',
    footerToolsTitle: 'Wichtige pic-tool-Tools',
    footerToolsIntro: 'Schnellzugriff auf Screenshot-, Bild-, Video- und lokale Browser-Tools.',
    localProcessing: {
        title: 'Kein Upload, lokale Verarbeitung',
        cont1: 'Ihre Dateien werden lokal im Browser verarbeitet. pic-tool muss Bilder oder Videos für diese Tools nicht auf einen Server hochladen.',
