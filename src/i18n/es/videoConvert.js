...
export default {
    ...en,
    poweredByPre: 'Conversión de vídeo con ',
    poweredByMid: '. Modelo de interacción adaptado de ',
    poweredByPost: '.',
    title: 'Creador de GIF, Video a GIF y MP4 a GIF | pic-tool',
    ...
    seoIntro: 'pic-tool Video Convert es un creador de GIF local, un convertidor de video a GIF y una herramienta MP4 a GIF basada en ffmpeg.wasm. Cubre flujos comunes inspirados en ffmpeg-webCLI y mantiene los archivos dentro del navegador.',
    featureSections: [
        {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: 'Sí. El archivo se procesa localmente en tu navegador con ffmpeg.wasm. pic-tool no sube tu video a un servidor de conversión.'
        },
        {
